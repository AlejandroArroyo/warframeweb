...
/**
 * Lista completa de reliquias del Vacío de Warframe.
 * Obtenida de la Wiki oficial de Warframe.
 * Formato: { era: string, name: string }
 */
const RELICS = [
  // ===== LITH =====
  ...
  { era: 'Axi', name: 'H1' }, { era: 'Axi', name: 'H2' }, { era: 'Axi', name: 'H3' },
  { era: 'Axi', name: 'K1' },
  { era: 'Axi', name: 'L1' },
  { era: 'Axi', name: 'N1' }, { era: 'Axi', name: 'N2' }, { era: 'Axi', name: 'N3' }, { era: 'Axi', name: 'N4' }, { era: 'Axi', name: 'N5' }, { era: 'Axi', name: 'N6' }, { era: 'Axi', name: 'N7' }, { era: 'Axi', name: 'N8' },
  { era: 'Axi', name: 'P1' },
  { era: 'Axi', name: 'S1' }, { era: 'Axi', name: 'S2' }, { era: 'Axi', name: 'S3' }, { era: 'Axi', name: 'S4' }, { era: 'Axi', name: 'S5' }, { era: 'Axi', name: 'S6' }, { era: 'Axi', name: 'S7' }, { era: 'Axi', name: 'S8' }, { era: 'Axi', name: 'S9' }, { era: 'Axi', name: 'S10' },
  ...
  { era: 'Axi', name: 'V1' }, { era: 'Axi', name: 'V2' }, { era: 'Axi', name: 'V3' }, { era: 'Axi', name: 'V4' }, { era: 'Axi', name: 'V5' }, { era: 'Axi', name: 'V6' }, { era: 'Axi', name: 'V7' }, { era: 'Axi', name: 'V8' }, { era: 'Axi', name: 'V9' },
  { era: 'Axi', name: 'X1' },
];
...
async function main() {
  ...
  for (const relic of RELICS) {
    await prisma.relic.create({
      data: {
        era: relic.era as any,
        name: relic.name,
      },
    });
  }

  console.log(`✅ Inserted ${RELICS.length} relics`);
